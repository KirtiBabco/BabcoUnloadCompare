/* Babco Unload Compare v1.2.0 - existing APPLICATION database upgrade. Safe/additive. */
SET XACT_ABORT ON;
GO
IF OBJECT_ID('dbo.UC_ReceivingHeader','U') IS NULL THROW 51000, 'UC_ReceivingHeader does not exist. Run 01_Schema.sql first.', 1;
GO
